...
from direct.tkpanels.Inspector import ClassInspector
...
with col3:
    st.image(r"C:\Users\user\PycharmProjects\python_scripts\cyber_proj\final\ball_image1.png", width=600)

with col1:
    st.image(r"C:\Users\user\PycharmProjects\python_scripts\cyber_proj\final\ball_image2.png", width=600)
